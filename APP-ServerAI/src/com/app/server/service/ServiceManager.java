...
public class ServiceManager {
	...
	private LineInfoService userInfoService;
	...
	public void initService() {
		try {
			this.loadConfig();
			this.userInfoService = new LineInfoService();
			this.lineService = new LineService();
			this.configService = new ConfigService();
			this.serverListService = new ServerListService();
			this.udidService = new UdidService();//测试账号
	...
	public LineInfoService getUserInfoService() {
