...
public class Geometry implements Serializable, Cloneable {
	...
	public static float GEO_MIN_X = -499999.0f;
	public static float GEO_MAX_X = 500000.0f;
	public static float GEO_MIN_Z = -499999.0f;
	public static float GEO_MAX_Z = 500000.0f;
	...
	public Geometry[] divide() {
		...
		final Geometry[] ga = {new Geometry(this.minX, this.minX + lhalfX + 1.0f, this.minZ, this.minZ + lhalfZ + 1.0f),
				new Geometry(this.minX + lhalfX + 1.0f, this.maxX, this.minZ, this.minZ + lhalfZ + 1.0f), new Geometry(this.minX, this.minX + lhalfX + 1.0f, this.minZ + lhalfZ + 1.0f, this.maxZ),
				new Geometry(this.minX + lhalfX + 1.0f, this.maxX, this.minZ + lhalfZ + 1.0f, this.maxZ)};
		return ga;
	}
