...
import  com.app.server.atavism.server.pathing.detour.MeshHeader;
import java.util.List;

import org.apache.log4j.Logger;
import org.w3c.dom.NodeList;
import  com.app.server.atavism.server.pathing.detour.OffMeshConnection;
import  com.app.server.atavism.server.pathing.detour.BVNode;
import  com.app.server.atavism.server.pathing.detour.PolyDetail;
import  com.app.server.atavism.server.pathing.detour.Link;
import  com.app.server.atavism.server.pathing.detour.Poly;
...
public class NavMeshXmlLoader {
	...
	public boolean parse() {
		try {
			...
			log.warn("WorldFileLoader.parse(" + this.navMeshBuilderFileName + ")", e);
			return false;
		}
		return true;
	}
