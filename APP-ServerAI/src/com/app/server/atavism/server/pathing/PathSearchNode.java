...
public class PathSearchNode {
	...
	protected static final Logger log = Logger.getLogger("PathSearchNode");
	...
	public String shortString() {
		return "[PathSearchNode  polyIndex = " + this.polyIndex + "; loc = " + this.loc + "; arc = " + ((this.arc == null) ? "null" : this.arc.shortString()) + "; costSoFar = " + this.costSoFar
				+ "; costToGoal = " + this.costToGoal + "]";
	}
