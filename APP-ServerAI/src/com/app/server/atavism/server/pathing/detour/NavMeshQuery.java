...
public class NavMeshQuery
{
    ...
    public DetourStatusReturn FindPath(final long startRef, final long endRef, final float[] startPos, final float[] endPos, final QueryFilter filter, final long[] path, final int pathCount, final int maxPath) {
        try {
        ...
        while (!this._openList.Empty()) {
            ...
            while (true) {
                ...
                if (n2 == com.app.server.atavism.server.pathing.detour.NavMesh.NullLink) {
                    break;
                }
                        ...
                        if (filter.PassFilter(neighborRef, neighbourTile, neighbourPoly)) {
                            ...
                            if (neighbourNode == null) {
                                ...
                                if (neighborRef == endRef) {
                                    final float curCost = filter.GetCost(bestNode.Pos[0], bestNode.Pos[1], bestNode.Pos[2], neighbourNode.Pos[0], neighbourNode.Pos[1], neighbourNode.Pos[2], parentRef, parentTile, parentPoly, bestRef, bestTile, bestPoly, neighborRef, neighbourTile, neighbourPoly);
                                    final float endCost = filter.GetCost(neighbourNode.Pos[0], neighbourNode.Pos[1], neighbourNode.Pos[2], endPos[0], endPos[1], endPos[2], bestRef, bestTile, bestPoly, neighborRef, neighbourTile, neighbourPoly, 0L, null, null);
    ...
    public DetourStatusReturn FindStraightPath(final float[] startPos, final float[] endPos, final long[] path, final int pathSize, final float[] straightPath, final short[] straightPathFlags, final long[] straightPathRefs, final int maxStraightPath) {
    ...
    public DetourStatusReturn FindStraightPath(final float[] startPos, final float[] endPos, final long[] path, final int pathSize, final float[] straightPath, final short[] straightPathFlags, final long[] straightPathRefs, final int maxStraightPath, final int options) {
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
            }
    ...
    public DetourStatusReturn UpdateSlicedFindPath(final int maxIter) {
        ...
        while (iter < maxIter && !this._openList.Empty()) {
            ...
            while (true) {
                final long n = i;
                final NavMesh navMesh = this.NavMesh;
                if (n == com.app.server.atavism.server.pathing.detour.NavMesh.NullLink) {
                    break;
                }
                final long neighborRef = bestTile.Links[(int)i].Ref;
                if (neighborRef > 0L) {
                        ...
                        if (this._query.Filter.PassFilter(neighborRef, neighborTile, neighborPoly)) {
                            ...
                            if (neighborNode == null) {
                                ...
                                if (neighborRef == this._query.EndRef) {
                                    final float curCost = this._query.Filter.GetCost(bestNode.Pos[0], bestNode.Pos[1], bestNode.Pos[2], neighborNode.Pos[0], neighborNode.Pos[1], neighborNode.Pos[2], parentRef, parentTile, parentPoly, bestRef, bestTile, bestPoly, neighborRef, neighborTile, neighborPoly);
                                    final float endCost = this._query.Filter.GetCost(neighborNode.Pos[0], neighborNode.Pos[1], neighborNode.Pos[2], this._query.EndPos[0], this._query.EndPos[1], this._query.EndPos[2], bestRef, bestTile, bestPoly, neighborRef, neighborTile, neighborPoly, 0L, null, null);
                                    cost = bestNode.Cost + curCost + endCost;
                                    heuristic = 0.0f;
                                }
                                else {
                                    final float curCost = this._query.Filter.GetCost(bestNode.Pos[0], bestNode.Pos[1], bestNode.Pos[2], neighborNode.Pos[0], neighborNode.Pos[1], neighborNode.Pos[2], parentRef, parentTile, parentPoly, bestRef, bestTile, bestPoly, neighborRef, neighborTile, neighborPoly);
                                    cost = bestNode.Cost + curCost;
                                    heuristic = Helper.VDist(neighborNode.Pos[0], neighborNode.Pos[1], neighborNode.Pos[2], this._query.EndPos[0], this._query.EndPos[1], this._query.EndPos[2]) * NavMeshQuery.HScale;
                                }
                                final float total = cost + heuristic;
    ...
    public DetourStatusReturn FindPolysAroundCircle(final long startRef, final float[] centerPos, final float radius, final QueryFilter filter, final long[] resultRef, final long[] resultParent, final float[] resultCost, final int maxResult) {
        final DetourStatusReturn statusReturn = new DetourStatusReturn();
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
                            ...
                            if (this.GetPortalPoints(bestRef, bestPoly, bestTile, neighborRef, neighborPoly, neighborTile, va, vb).contains(Status.Success)) {
                                ...
                                if (distSqr <= radiusSqr) {
                                    ...
                                    if (neighborNode == null) {
                                        ...
                                        final float total = bestNode.Total + Helper.VDist(bestNode.Pos[0], bestNode.Pos[1], bestNode.Pos[2], neighborNode.Pos[0], neighborNode.Pos[1], neighborNode.Pos[2]);
                                        if ((neighborNode.Flags & Node.NodeOpen) == 0x0L || total < neighborNode.Total) {
                                            neighborNode.Id = neighborRef;
                                            neighborNode.Flags &= ~Node.NodeClosed;
                                            neighborNode.PIdx = this.NodePool.GetNodeIdx(bestNode);
    ...
    public DetourStatusReturn FindPolysAroundShape(final long startRef, final float[] verts, final int nverts, final QueryFilter filter, final long[] resultRef, final long[] resultParent, final float[] resultCost, final int maxResult) {
        final DetourStatusReturn statusReturn = new DetourStatusReturn();
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
    ...
    public DetourStatusReturn FindLocalNeighbourhood(final long startRef, final float[] centerPos, final float radius, final QueryFilter filter, final long[] resultRef, final long[] resultParent, final int maxResult) {
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
            }
                                        ...
                                        if (distSqr <= radiusSqr) {
                                            ...
                                            for (final long pastRef : resultRef) {
                                                ...
                                                while (true) {
                                                    ...
                                                    if (n3 == com.app.server.atavism.server.pathing.detour.NavMesh.NullLink) {
                                                        break;
                                                    }
    ...
    public DetourStatusReturn MoveAlongSurface(final long startRef, final float[] startPos, final float[] endPos, final QueryFilter filter, final float[] resultPos, final long[] visited, final int maxVisitedSize) {
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
            }
                    ...
                    for (int m = 0; m < nneis; ++m) {
                        ...
                        if (neighborNode != null) {
                            if ((neighborNode.Flags & Node.NodeClosed) == 0x0L) {
                                final int vj2 = k * 3;
                                final int vi2 = j * 3;
                                final Vector2 distSqr2 = Helper.DistancePtSegSqr2D(searchPos[0], searchPos[1], searchPos[2], verts[vj2 + 0], verts[vj2 + 1], verts[vj2 + 2], verts[vi2 + 0], verts[vi2 + 1], verts[vi2 + 2]);
    ...
    public DetourNumericReturn FindDistanceToWall(final long startRef, final float[] centerPos, final float maxRadius, final QueryFilter filter, final float hitDist, final float[] hitPos, float[] hitNormal) {
        try {
            if (this.NavMesh == null) {
                throw new Exception("NavMesh is not initialized");
            }
        ...
        while (!this._openList.Empty()) {
            ...
            while (i < bestPoly.VertCount) {
                Label_0849: {
                    ...
                    final Vector2 distVec = Helper.DistancePtSegSqr2D(centerPos[0], centerPos[1], centerPos[2], bestTile.Verts[vj + 0], bestTile.Verts[vj + 1], bestTile.Verts[vj + 2], bestTile.Verts[vi + 0], bestTile.Verts[vi + 1], bestTile.Verts[vi + 2]);
                ...
                if (neighborRef > 0L) {
                    if (neighborRef != parentRef) {
                        ...
                        if (neighborPoly.getType() != NavMeshBuilder.PolyTypeOffMeshConnection) {
                            ...
                            final Vector2 distSqr2 = Helper.DistancePtSegSqr2D(centerPos[0], centerPos[1], centerPos[2], bestTile.Verts[va + 0], bestTile.Verts[va + 1], bestTile.Verts[va + 2], bestTile.Verts[vb + 0], bestTile.Verts[vb + 1], bestTile.Verts[vb + 2]);
    ...
    public DetourNumericReturn FindRandomPointAroundCircle(final long startRef, final float[] centerPos, final float radius, final QueryFilter filter, final Random frand, final long randomRef, final float[] randomPt) {
        final DetourNumericReturn statusReturn = new DetourNumericReturn();
        ...
        if (fromPoly.getType() == NavMeshBuilder.PolyTypeOffMeshConnection) {
            ...
            if (toPoly.getType() != NavMeshBuilder.PolyTypeOffMeshConnection) {
                ...
                if (link.Side != 255 && (link.BMin != 0 || link.BMax != 255)) {
                    ...
                    left = Helper.VLerp(left, fromTile.Verts[v2 * 3 + 0], fromTile.Verts[v2 * 3 + 1], fromTile.Verts[v2 * 3 + 2], fromTile.Verts[v3 + 3 + 0], fromTile.Verts[v3 + 3 + 1], fromTile.Verts[v3 + 3 + 2], tmin);
                    right = Helper.VLerp(right, fromTile.Verts[v2 * 3 + 0], fromTile.Verts[v2 * 3 + 1], fromTile.Verts[v2 * 3 + 2], fromTile.Verts[v3 + 3 + 0], fromTile.Verts[v3 + 3 + 1], fromTile.Verts[v3 + 3 + 2], tmax);
                }
                return EnumSet.of(Status.Success);
            }
            i = toPoly.FirstLink;
    ...
    private DetourStatusReturn AppendVertex(final float[] pos, final short flags, final long refId, final float[] straightPath, final short[] straightPathFlags, final long[] straightPathRefs, int straightPathCount, final int maxStraightPath) {
        final DetourStatusReturn statusReturn = new DetourStatusReturn();
        if (straightPathCount > 0 && Helper.VEqual(straightPath[(straightPathCount - 1) * 3 + 0], straightPath[(straightPathCount - 1) * 3 + 1], straightPath[(straightPathCount - 1) * 3 + 2], pos[0], pos[1], pos[2])) {
    ...
    private DetourStatusReturn AppendPortals(final int startIdx, final int endIdx, final float[] endPos, final long[] path, final float[] straightPath, final short[] straightPathFlags, final long[] straightPathRefs, final int straightPathCount, final int maxStraightPath, final int options) {
        final DetourStatusReturn statusReturn = new DetourStatusReturn();
        statusReturn.intValue = straightPathCount;
        ...
        for (int i = startIdx; i < endIdx; ++i) {
            ...
            if ((options & NavMeshQuery.StraightPathAreaCrossings) == 0x0 || fromPoly.getArea() != toPoly.getArea()) {
                final DetourNumericReturn segIntersected = Helper.IntersectSegSeg2D(straightPath[startPos + 0], straightPath[startPos + 1], straightPath[startPos + 2], endPos[0], endPos[1], endPos[2], left, right);
