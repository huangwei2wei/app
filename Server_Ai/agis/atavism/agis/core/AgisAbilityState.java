	...
	public void updateState() {
		...
		try {
			...
			case ACTIVATING: {
				...
				EventMessageHelper.SendCombatEvent(this.source.getOwnerOid(), this.target.getOwnerOid(), "CastingStarted", this.ability.id, -1,
						(int) (this.ability.getActivationTime() / 1000L), -1);
