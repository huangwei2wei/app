...
public class SpawnGenerator implements MessageCallback, MessageDispatch, Runnable {
	...
	private static Map<OID, HashMap<Integer, SpawnGenerator>> instanceContent = new HashMap<OID, HashMap<Integer, SpawnGenerator>>();
	...
	protected void removeDeathWatch(final OID oid) {
		...
		if (sub != null) {
			...
			Engine.getAgent().removeSubscription((long) sub);
		}
	}
