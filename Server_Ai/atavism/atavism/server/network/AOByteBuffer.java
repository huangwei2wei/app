		...
		if (val == null) {
			...
			switch (index) {
				...
				case 12 : {
					...
					putByte(((Byte) val).byteValue());
					break;
				}
				case 13 : {
					this.putByte((byte) 13);
					putShort(((Short) val).shortValue());
					break;
				}
				case 3 : {
					this.putByte((byte) 3);
					putInt(((Integer) val).intValue());
					break;
				}
				case 4 : {
					putByte(((Boolean) val).booleanValue() ? (byte) 5 : (byte) 4);
					break;
				}
				case 6 : {
					this.putByte((byte) 6);
					putFloat(((Float) val).floatValue());
					break;
				}
				case 7 : {
					this.putByte((byte) 7);
