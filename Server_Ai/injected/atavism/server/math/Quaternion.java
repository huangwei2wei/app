...
public class Quaternion implements Externalizable, Cloneable, Marshallable
{
    private float _x;
    private float _y;
    private float _z;
    ...
    public void marshalObject(final AOByteBuffer buf) {
        buf.putFloat(this._x);
        buf.putFloat(this._y);
        buf.putFloat(this._z);
        buf.putFloat(this._w);
    }
    
    public Object unmarshalObject(final AOByteBuffer buf) {
        this._x = buf.getFloat();
        this._y = buf.getFloat();
        this._z = buf.getFloat();
        this._w = buf.getFloat();
        return this;
    }
}
