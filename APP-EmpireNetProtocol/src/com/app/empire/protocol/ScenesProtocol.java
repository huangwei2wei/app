...
public class ScenesProtocol {
	...
	public static final short	BATTLE_PlayerSkillLiving	= 10;		// 同步 玩家杀死怪物或人到worldserver
	/** 场景 **/
	public static final short	MAIN_WARFIELD				= 10004;
	public static final short	WARFIELD_EnterField			= 1;		// 进入场景
