 ...
 * 
 */
public class ReturnAttack extends AbstractData {
	...
	public ReturnAttack(int sessionId, int serial) {
		super(Protocol.MAIN_SYN, Protocol.SYN_ReturnAttack, sessionId, serial);
	}
	public ReturnAttack() {
		super(Protocol.MAIN_SYN, Protocol.SYN_ReturnAttack);
	}
	public int getId() {
		return id;
	}
