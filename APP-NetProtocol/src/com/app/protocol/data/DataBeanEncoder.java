...
public class DataBeanEncoder {
	...
	public INetSegment encode(AbstractData data) throws Exception {
		try {
			INetSegment segment = ProtocolManager.getNetSegmentInstance(data.getType(), data.getSubType(), data.getSessionId(), data.getSerial(), data.getTarget(), data.getProType());
