...
public class NavmeshSeeker {
	...
	public NavmeshSeekerStatuCode seek(Vector3 startPos, Vector3 endPos, List<Vector3> path, int offset) {
		...
		NavmeshSeekerStatuCode code = seekTrianglePath(new Vector2(startPos.x, startPos.z), new Vector2(endPos.x,
				endPos.z), pathTri, offset);
	 ...
	 * @return
	 */
	private NavmeshSeekerStatuCode seekTrianglePath(Vector2 startPos, Vector2 endPos, List<NavmeshTriangle> pathList,
			int offset) {
	 ...
	 * @return
	 */
	private NavmeshSeekerStatuCode createWayPoints(Vector3 startPos, Vector3 endPos, List<NavmeshTriangle> triPathList,
		...
		NavmeshWayPoint wayPoint = new NavmeshWayPoint(triPathList.get(0), new Vector2(startPos.x, startPos.z),
				startPos);
