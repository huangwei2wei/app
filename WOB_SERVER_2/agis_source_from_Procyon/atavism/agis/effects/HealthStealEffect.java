...
public class HealthStealEffect extends AgisEffect
{
    ...
    static {
        HealthStealEffect.random = new Random();
    }
    
    public HealthStealEffect(final int id, final String name) {
        super(id, name);
        this.minDmg = 0;
        this.maxDmg = 0;
        this.minPulseDmg = 0;
    ...
    public void apply(final EffectState state) {
        ...
        switch (result) {
            ...
            default: {
                dmg = this.minDmg;
                dmg = CombatHelper.CalcMagicalDamage(target, caster, dmg, this.damageType, this.skillEffectMod.get(0), this.effectSkillType, this.hitRoll, true);
                if (this.DamageMod != 1.0) {
                ...
                switch (result) {
                    ...
                    case 2: {
                        dmg *= 2;
                        abilityEvent = "CombatMagicalCritical";
                        break;
                    }
                }
                if (Log.loggingDebug) {
        ...
        if (dmg > 0) {
            ...
            final double healD = dmg * this.transferModifier;
