    ...
    public class GetQuestStatusHook implements Hook
    {
        public boolean processMessage(final Message msg, final int flags) {
            ...
            try {
                ...
                if (questType == 1) {
                    Engine.getAgent().sendObjectResponse((Message)pMsg, qsInfo.getCurrentActiveQuests());
                }
                else if (questType == 2) {
                    Engine.getAgent().sendObjectResponse((Message)pMsg, qsInfo.getCurrentCompletedQuests());
                }
                else {
                    Engine.getAgent().sendObjectResponse((Message)pMsg, qsInfo.getAllQuests());
                }
    ...
    public class GetQuestItemReqsHook implements Hook
    {
        public boolean processMessage(final Message msg, final int flags) {
            ...
            try {
                ...
                Engine.getAgent().sendObjectResponse((Message)pMsg, itemList);
