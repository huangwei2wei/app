...
public class CombatPlugin extends EnginePlugin
{
    ...
    public static void resolveAutoAttack(final CombatInfo info) {
        ...
        final OID targetOid = info.getAutoAttackTarget();
        final CombatInfo target = getCombatInfo(targetOid);
        if (target == null) {
            return;
        }
    ...
    public static void sendAbilityUpdate(final CombatInfo info) {
        ...
        final CombatClient.AbilityUpdateMessage msg = new CombatClient.AbilityUpdateMessage(info.getOwnerOid(), info.getOwnerOid());
    ...
    public HashMap<String, AgisStat> getStartingStats(final int level, final boolean isMob, final int baseHealth, final int healthMod, final int baseMana, final int manaMod, final HashMap<String, Integer> statOverrides) {
    ...
    class ReleaseObjectHook implements Hook
    {
        public boolean processMessage(final Message msg, final int flags) {
            ...
            Log.debug("RELEASE: 5");
            EnginePlugin.setObjectPropertiesNoResponse(info.getOwnerOid(), Namespace.WORLD_MANAGER, new Serializable[] { "world.nomove", new Boolean(false), "world.noturn", new Boolean(false) });
            Log.debug("RELEASE: 7");
        ...
        public boolean processMessage(final Message msg, final int flags) {
            ...
            if (dead != null && dead) {
                ...
                if (attackers != null) {
                    ...
                    final LinkedList<String> questCategories = (LinkedList<String>)EnginePlugin.getObjectProperty(obj.getOwnerOid(), WorldManagerClient.NAMESPACE, "questCategories");
