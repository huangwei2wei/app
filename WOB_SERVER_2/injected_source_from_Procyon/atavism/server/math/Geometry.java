...
public class Geometry implements Serializable, Cloneable, Marshallable
{
    float minX;
    float maxX;
    float minZ;
    ...
    public void marshalObject(final AOByteBuffer buf) {
        buf.putFloat(this.minX);
        buf.putFloat(this.maxX);
        buf.putFloat(this.minZ);
        buf.putFloat(this.maxZ);
    }
