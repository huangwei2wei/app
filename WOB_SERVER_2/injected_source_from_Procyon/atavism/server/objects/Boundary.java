...
public class Boundary implements Cloneable, Serializable, Marshallable
{
    ...
    public void marshalObject(final AOByteBuffer buf) {
        ...
        if (this.boundingBox != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.boundingBox);
        }
        if (this.pointList != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.pointList);
        }
        if (this.name != null && this.name != "") {
    ...
    public Object unmarshalObject(final AOByteBuffer buf) {
        ...
        if ((flag_bits0 & 0x1) != 0x0) {
            this.boundingBox = (Geometry)MarshallingRuntime.unmarshalObject(buf);
        }
        if ((flag_bits0 & 0x2) != 0x0) {
            this.pointList = (List<Point>)MarshallingRuntime.unmarshalObject(buf);
        }
