...
public class Entity extends NamedPropertyClass implements Serializable, Marshallable
{
    protected static Set<Object> transientPropertyKeys;
    ...
    private transient Map<String, Serializable> transientMap;
    ...
    public static boolean equals(final Entity obj1, final Entity obj2) {
        return obj1 != null && obj2 != null && obj1.getOid().equals((Object)obj2.getOid()) && obj1.namespaceByte == obj2.namespaceByte;
    }
    ...
    public List<Namespace> getSubObjectNamespaces() {
        this.lock.lock();
        try {
            return (List<Namespace>)Namespace.decompressNamespaceList(this.subObjectNamespacesInt);
        }
        finally {
            this.lock.unlock();
        }
    ...
    public void setSubObjectNamespaces(final Set<Namespace> namespaces) {
        this.lock.lock();
        try {
            this.subObjectNamespacesInt = Namespace.compressNamespaceList((Set)namespaces);
        }
        finally {
            this.lock.unlock();
        }
    ...
    public void marshalObject(final AOByteBuffer buf) {
        ...
        byte flag_bits = 0;
        if (this.subObjectNamespacesInt != null) {
            flag_bits = 1;
        }
        if (this.oid != null) {
            flag_bits |= 0x2;
        ...
        if (this.subObjectNamespacesInt != null) {
            buf.putInt((int)this.subObjectNamespacesInt);
        }
        buf.putByte(this.namespaceByte);
        buf.putByte((byte)(byte)(this.persistEntity ? 1 : 0));
        if (this.oid != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.oid);
        }
        if (this.type != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.type);
        }
    }
    ...
    public Object unmarshalObject(final AOByteBuffer buf) {
        ...
        if ((flag_bits0 & 0x1) != 0x0) {
            this.subObjectNamespacesInt = buf.getInt();
        }
        this.namespaceByte = buf.getByte();
        this.persistEntity = (buf.getByte() != 0);
        if ((flag_bits0 & 0x2) != 0x0) {
            this.oid = (OID)MarshallingRuntime.unmarshalObject(buf);
        }
        if ((flag_bits0 & 0x4) != 0x0) {
            this.type = (ObjectType)MarshallingRuntime.unmarshalObject(buf);
        }
        return this;
    }
}
