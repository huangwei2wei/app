...
public class PathEdge implements Serializable, Cloneable, Marshallable
{
    AOVector start;
    AOVector end;
    ...
    public Object unmarshalObject(final AOByteBuffer buf) {
        ...
        if ((flag_bits0 & 0x1) != 0x0) {
            this.start = (AOVector)MarshallingRuntime.unmarshalObject(buf);
        }
        if ((flag_bits0 & 0x2) != 0x0) {
            this.end = (AOVector)MarshallingRuntime.unmarshalObject(buf);
        }
        return this;
    }
}
