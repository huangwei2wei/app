...
public class PathPolygon implements Serializable, Cloneable, Marshallable
{
    ...
    public void marshalObject(final AOByteBuffer buf) {
        ...
        buf.putByte(this.polygonKind);
        if (this.corners != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.corners);
        }
        if (this.plane != null) {
            MarshallingRuntime.marshalObject(buf, (Object)this.plane);
        }
    }
    ...
    public Object unmarshalObject(final AOByteBuffer buf) {
        ...
        this.polygonKind = buf.getByte();
        if ((flag_bits0 & 0x1) != 0x0) {
            this.corners = (List<AOVector>)MarshallingRuntime.unmarshalObject(buf);
        }
        if ((flag_bits0 & 0x2) != 0x0) {
            this.plane = (Plane)MarshallingRuntime.unmarshalObject(buf);
        }
        return this;
    }
}
