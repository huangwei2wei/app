...
public class EnginePlugin implements MessageCallback, StatusMapCallback
{
    ...
    public void registerPluginNamespaces(final Collection<Namespace> namespaces, final GenerateSubObjectHook genSubObjHook, final INamespaceFilter selectionFilter, final INamespaceFilter subObjectFilter) {
        this.registerPluginNamespaces(namespaces, genSubObjHook, null, null, null, null, selectionFilter, subObjectFilter);
    }
    
    public void registerPluginNamespaces(final Collection<Namespace> namespaces, final GenerateSubObjectHook genSubObjHook, Hook loadSubObjHook, Hook saveSubObjHook, Hook unloadSubObjHook, Hook deleteSubObjHook, INamespaceFilter selectionFilter, INamespaceFilter subObjectFilter) {
        if (Log.loggingDebug) {
            String s = "";
