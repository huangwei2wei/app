...
public class PathIntersection
{
    ...
    public String toString() {
        return "[PathIntersecton line1 = " + this.line1 + " line2 = " + this.line2 + " where1 = " + this.where1 + " where2 = " + this.where2 + "; cvPoly = " + this.cvPoly + " pathObject = " + this.pathObject;
    }
    ...
    public static PathIntersection findIntersection(final PathObject pathObject, final float start1x, final float start1z, final float disp1x, final float disp1z, final float start2x, final float start2z, final float disp2x, final float disp2z) {
    ...
    public static PathIntersection findIntersection(final PathObject pathObject, final PathPolygon cvPoly, final float start1x, final float start1z, final float disp1x, final float disp1z, final float start2x, final float start2z, final float disp2x, final float disp2z) {
