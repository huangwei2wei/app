...
public class PathSearcher
{
    ...
    private PathFinderValue findPathInternal(final String type, final AOVector loc1, final AOVector loc2) {
        ...
        if (PathSearcher.logAll) {
            PathSearcher.log.debug("findPathInternal: startModel = " + this.tOrF(needEgressFromStartModel) + "; crossTerrain = " + this.tOrF(needToCrossTerrain) + "; endModel = " + this.tOrF(needEntryToEndModel));
        }
    ...
    public PathResult findPathThroughTerrain(final PathFinderValue value, final String type, final AOVector loc1, final AOVector loc2, final PathObjectLocation poLoc2, final AOVector entryPortalLoc, final float halfWidth, final boolean haveStartModel, final boolean haveEndModel) {
        if (PathSearcher.logAll) {
    ...
    AOVector findPathAroundObstacle(final String type, final PathFinderValue value, final PathIntersection intersection, final AOVector loc1, final AOVector loc2, final PathObjectLocation poLoc2, final AOVector entryPortalLoc, final float halfWidth) {
        ...
        if (PathSearcher.logAll) {
            PathSearcher.log.debug("findPathAroundObstacle: loc1 = " + loc1 + "; corner1 = " + corner1 + "; cornerPoint1 = " + cornerPoint1 + "; terrainPoly1 = " + terrainPoly1 + "; endModel = " + this.tOrF(endModel) + "; loc2 = " + loc2 + "; endPoint = " + endPoint + "; endPoint = " + endPoint + "; endPolygon = " + endPolygon);
        }
