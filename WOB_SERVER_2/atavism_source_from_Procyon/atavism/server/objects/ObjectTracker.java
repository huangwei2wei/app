...
public class ObjectTracker implements MessageCallback, MessageDispatch
{
    ...
    public ObjectTracker(final Namespace namespace, final OID instanceOid, final EntityWithWorldNodeFactory entityFactory, final float hystericalMargin, final NotifyReactionRadiusCallback notifyCallback, final RemoteObjectFilter remoteObjectFilter) {
        this.hystericalMargin = 0.0f;
        this.notifyCallback = null;
        this.remoteObjectFilter = null;
        this.localObjects = new HashSet<OID>();
    ...
    private void initialize(final Namespace namespace, final OID oid, final EntityWithWorldNodeFactory entityFactory, final Collection<ObjectType> subjectTypes) {
        ...
        (this.perceptionFilter = new TrackerFilter()).setTrackedInstanceOid(oid);
        this.perceptionFilter.addType(WorldManagerClient.MSG_TYPE_PERCEPTION);
    ...
    public void addLocalObject(final OID oid, final Integer reactionRadius) {
        ...
        try {
            ...
            if (this.perceptionFilter.addTarget(oid)) {
                final FilterUpdate filterUpdate = new FilterUpdate(1);
                filterUpdate.addFieldValue(1, oid);
