...
public class GetSkillListHandler implements IDataHandler {
	public AbstractData handle(AbstractData data) throws Exception {
		...
		Map<Integer, List<Skill>> getHeroSkill = ServiceManager.getManager().getPlayerSkillService().getHeroSkill(worldPlayer, heroIdList);
		...
		for (Entry<Integer, List<Skill>> entry : getHeroSkill.entrySet()) {
