...
public class FieldSpawn implements java.io.Serializable {
	...
	/** minimal constructor */
	public FieldSpawn(Integer id, Integer tagId, String preSpawanId, String nextSpawanId, String strParam3, String timerBegin) {
		this.id = id;
		this.tagId = tagId;
	...
	/** full constructor */
	public FieldSpawn(Integer id, Integer mapid, Integer boundX, Integer boundY, Integer boundZ, Integer angle, Short initStatu, Integer tagId, String preSpawanId,
			String nextSpawanId, Integer progress, Integer wakeType, Integer wakeDelay, Integer toalCount, Integer maxCount, Integer campaignFeatures, Integer entityId,
			Integer param1, Integer param2, Integer param3, Integer param4, String strParam1, String strParam2, String strParam3, Integer restSecs, Integer restType,
			String timerBegin, Integer timerType, String timerEnd, Integer initSecs, Integer entityType) {
		this.id = id;
		this.mapid = mapid;
		this.boundX = boundX;
		this.boundY = boundY;
	...
	@Column(name = "strParam3", nullable = false)
	...
	@Column(name = "timer_begin", nullable = false, length = 11)
