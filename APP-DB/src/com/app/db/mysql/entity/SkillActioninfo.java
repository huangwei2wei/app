...
public class SkillActioninfo implements java.io.Serializable {
	...
	/** full constructor */
	public SkillActioninfo(Integer templateId, Integer masterType, Integer sonType, Integer combo, Integer maxCombo, Integer animation, Integer audio, Integer search,
			Integer effect, Integer move, Integer camera, Integer attackTimes, Integer costType, Integer costCount, Integer attackType, Integer paramValue1, Integer paramValue2,
			Integer paramValue3, Integer paramParent1, Integer paramParent2, Integer paramParent3, String bufferIds, String snareIds, Integer random, Integer isCrit,
			Integer priority, Integer costTime, Integer cooldown) {
		this.templateId = templateId;
	...
	@Column(name = "snareIds")
	public String getSnareIds() {
		return this.snareIds;
	}
