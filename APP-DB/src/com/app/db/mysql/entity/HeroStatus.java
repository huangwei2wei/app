...
/**
 * HeroStatus entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "hero_status", catalog = "game_config")
public class HeroStatus implements java.io.Serializable {
	...
	/** full constructor */
	public HeroStatus(Integer id, String name, String type, Integer subBlood, Integer subSoul, Integer addBlood, Integer addSoul, Integer move, Integer attackMove,
